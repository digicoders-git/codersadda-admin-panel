              ...
              <div className="w-full aspect-video rounded-3xl bg-black shadow-2xl overflow-hidden relative group">
                {lecture.videoUrl ? (
                  <video
                    ...
                    poster={lecture.thumbnailUrl || course.thumbnail?.url}
                  ></video>
                ) : (
                  <div className="w-full h-full flex flex-col items-center justify-center text-white/40">
                    <VideoIcon size={80} className="mb-4 animate-pulse" />
                ...
                <div className="md:col-span-2 space-y-8">
                  ...
                  >
                    ...
                    <p className="text-xs font-medium opacity-50 leading-relaxed">
                      You are viewing this as an instructor. This is how the
                      lecture appears to your students.
                    </p>
                  </div>
                </div>
