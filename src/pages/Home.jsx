...
const Home = () => {
  ...
  const [data, setData] = useState({
    stats: {},
    sales: { daily: [], weekly: [], monthly: [], yearly: [], allTime: [] },
    trendingShorts: [],
    recentComments: [],
  });
  ...
  const getChartData = () => {
    switch (chartFilter) {
      ...
      case "By Year":
        return processChartData(data.sales.yearly, "year");
      case "By All Time":
        return processChartData(data.sales.allTime, "allTime");
      default:
        return processChartData(data.sales.weekly, "week");
    }
  };
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-2">
            {["By Day", "By Week", "By Month", "By Year", "By All Time"].map((filter) => (
              <button
                key={filter}
