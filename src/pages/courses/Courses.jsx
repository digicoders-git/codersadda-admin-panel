            ...
            {courses.map((course) =>
              viewMode === "grid" ? (
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    >
                      <div
                        ...
                        style={{ color: colors.textSecondary }}
                      >
                        <span className="flex items-center gap-1.5 px-2 py-0.5 rounded bg-blue-50 text-blue-600 border border-blue-100">
                          <Clock size={12} /> <span className="font-bold">{course.duration || "Not Set"}</span>
                        </span>
                ...
                >
                  ...
                  <div
                    className="flex items-center gap-4 text-[11px] font-bold uppercase tracking-widest mr-4"
                  >
                    <span className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-50 text-blue-700 border border-blue-100 shadow-sm">
