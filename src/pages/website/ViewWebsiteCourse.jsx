                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <img
                          src={
                            course.instructor?.profilePicture?.url || course.instructor?.profilePicture?.localUrl || course.instructorImage
                          }
                          onError={(e) => {
                            if (course.instructor?.profilePicture?.localUrl && e.target.src !== course.instructor.profilePicture.localUrl) {
                              e.target.src = course.instructor.profilePicture.localUrl;
                            }
                          }}
