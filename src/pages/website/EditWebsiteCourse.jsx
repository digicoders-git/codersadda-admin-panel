...
function EditWebsiteCourse() {
  ...
  const handleInstructorImageChange = (e) => {
    ...
    if (file) {
      ...
      const reader = new FileReader();
      reader.onloadend = () => {
        setFormData((prev) => ({ ...prev, instructorImage: reader.result }));
      };
      reader.readAsDataURL(file);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.title || !formData.category || !formData.instructor) {
      toast.warning("Please fill in all required fields (Title, Category, Instructor)");
      return;
    }
    ...
    // Only append files if they were newly selected
    if (imageFile) {
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                <label style={labelStyle}>Technology Stack (Ex: React, Node.js)</label>
                <input
                  type="text"
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      progress: e.target.value !== "" ? parseInt(e.target.value) : "",
                    })
                  }
                  placeholder="0-100"
                  className="w-full px-4 py-2 rounded-md border outline-none text-sm"
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <ModernSelect
                  options={instructors.map(inst => ({ value: inst._id, label: inst.fullName }))}
...
export default EditWebsiteCourse;
