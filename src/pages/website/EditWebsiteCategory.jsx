...
import { getCourseCategoryById, updateCourseCategory } from "../../apis/courseCategory";

function EditWebsiteCategory() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await updateCourseCategory(id, data);
      if (res.success) {
...
export default EditWebsiteCategory;
