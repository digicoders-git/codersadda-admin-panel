                  ...
                  >
                    ...
                    <td className="p-4 py-5">
                      <div className="flex items-center gap-3">
                        ...
                        >
                          {ins.profilePicture?.url && (
                            <img
                              src={ins.profilePicture?.url || ins.profilePicture?.localUrl}
                              alt={ins.fullName}
                              className="w-full h-full object-cover"
                              onError={(e) => {
                                if (ins.profilePicture?.localUrl && e.target.src !== ins.profilePicture.localUrl) {
                                  e.target.src = ins.profilePicture.localUrl;
                                }
                              }}
                            />
                          )}
