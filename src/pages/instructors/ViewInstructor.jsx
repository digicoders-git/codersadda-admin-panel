      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            >
              <div
                className="w-24 h-24 rounded-full border-4 overflow-hidden flex items-center justify-center mb-4 shadow-lg"

                style={{
                  borderColor: colors.primary + "30",
                }}
              >
                {(instructor.profilePicture?.url || instructor.profilePicture?.localUrl) && (
                  <img
                    src={instructor.profilePicture.url || instructor.profilePicture.localUrl}
                    alt={instructor.fullName}
                    className="w-full h-full object-cover"
                    onError={(e) => {
                      if (instructor.profilePicture?.localUrl && e.target.src !== instructor.profilePicture.localUrl) {
                        e.target.src = instructor.profilePicture.localUrl;
                      }
                    }}
                  />
                )}
