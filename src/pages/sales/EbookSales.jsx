...
import { Book, TrendingUp, Users, CheckCircle, XCircle } from "lucide-react";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error(err);
        toast.error("Failed to load ebook sales data");
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="p-6 space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          >
            Detailed analytics for ebook purchases
          </p>
        </div>
                      ...
                      <td className="p-3">
                        <div className="flex flex-col gap-0.5">
                          <span className="font-bold">
                            {txn.itemDetails?.title || "Unknown Ebook"}
                          </span>
                          <span className="text-[10px] opacity-60">
                            By {txn.itemDetails?.authorName || "Unknown"}
                          </span>
                        </div>
                      </td>
