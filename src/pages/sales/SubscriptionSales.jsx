...
function SubscriptionSales() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error(err);
        toast.error("Failed to load subscription sales data");
      } finally {
        setLoading(false);
      }
    };
  ...
  const lineChartOptions = {
    ...
    title: {
      text: "Subscription Revenue Trends",
    ...
    <div className="p-6 space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          >
            Detailed analytics for subscription plan purchases
          </p>
        </div>
                      ...
                      <td className="p-3">
                        <div className="flex flex-col gap-0.5">
                          <span className="font-bold">
                            {txn.itemDetails?.title || "Unknown Plan"}
                          </span>
                          <span className="text-[10px] opacity-60">
                            {txn.itemDetails?.duration || ""}
                          </span>
                        </div>
                      </td>
